 ...
 * to different parts of the buffer, so comparing the data pointers will not
 * work). AVBufferRef represents a single reference to an AVBuffer and it is
 * the object that may be manipulated by the caller directly.
 *
